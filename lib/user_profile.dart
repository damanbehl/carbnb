...
class UserProfile extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: CommonAppBar(title: const Text('User Profile'), leading: const SizedBox(), appBar: AppBar(), actions: const []),
      body: Column(
        ...
        children: [
          Expanded(child: Container(
            ...
            child: const CircleAvatar(radius: 100, backgroundColor: Colors.red,),
          ), flex: 4,),
          Expanded(child: Container(
    ...
    return Row(
      crossAxisAlignment: CrossAxisAlignment.center,
        children: [
          ...
          Text(fieldName, style: const TextStyle(fontWeight: FontWeight.bold, color: Colors.white, fontSize: 20),)
        ],
    );
  }
}